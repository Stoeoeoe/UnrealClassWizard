...
namespace Unreal_Class_Wizard.View
{
    ...
    /// </summary>
    public partial class SourceFoldersWindow : Window
    {

        private SourceFoldersViewModel viewModel;
        public event RoutedEventHandler OKButtonEvent;
        private bool restoreIfMove;


        public SourceFoldersWindow(string enginePath)
        {
            InitializeComponent();

            this.titleBar.Type = Unreal_Class_Wizard.CustomControls.UE4StyleTitleBarType.CloseOnly;

            viewModel = new SourceFoldersViewModel(enginePath);
